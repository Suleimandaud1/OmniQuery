...
- The key lives only in your browser's `localStorage` and is sent directly from your browser to Google's API. It never passes through any third-party server.
